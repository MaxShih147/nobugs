import { T, glass, STATUSES, statusColor, priorityColor, projectColor } from '../styles/tokens';
              ...
              {col.map((bug) => (
                ...
                onMouseLeave={(e) => {
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <span style={{ fontSize: '11px', color: projectColor(bug.project || bug.scope || ''), fontWeight: 500, fontFamily: T.fontSans }}>{bug.project || bug.scope || ''}</span>
