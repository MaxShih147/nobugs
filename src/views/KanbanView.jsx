...
export default function KanbanView({ bugs, onSelect }) {
  return (
    <div className="fade-in" style={{
      padding: 32, display: 'grid', gridTemplateColumns: `repeat(${STATUSES.length}, 1fr)`,
              ...
              {col.map((bug) => (
                ...
                onMouseLeave={(e) => { e.currentTarget.style.background = T.surface; e.currentTarget.style.transform = 'none'; }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <span style={{ fontSize: '11px', color: projectColor(bug.project), fontWeight: 500 }}>{bug.project}</span>
