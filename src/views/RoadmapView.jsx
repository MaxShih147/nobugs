import { T, glass, priorityColor, statusColor, statusSoft, projectColor, typeColor, stripEmoji } from '../styles/tokens';
                ...
                : sBugs.map((bug) => (
                  ...
                  onMouseLeave={(e) => {
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <span style={{ fontSize: '10px', color: bug.project ? projectColor(bug.project) : typeColor(bug.type || ''), fontFamily: T.fontSans }}>{stripEmoji(bug.project || bug.type || '')}</span>
