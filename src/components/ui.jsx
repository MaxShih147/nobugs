import { T, glass, priorityColor, prioritySoft, priorityDots, stripEmoji, statusColor, statusSoft, projectColor } from '../styles/tokens';
...
export function BugRow({ bug, onClick }) {
  return (
    ...
    onMouseLeave={(e) => (e.currentTarget.style.background = 'transparent')}>
      ...
      <span style={{ fontSize: '12px', color: projectColor(bug.project || bug.type || ''), fontFamily: T.fontSans }}>{stripEmoji(bug.project || bug.type || '')}</span>
